...
//    func makeRepositoriesListViewController(coordinator: RepositoriesListCoordinatorProtocol, service: RepositoryService = DefaultRepositoryService()) -> RepositoriesListViewController {
...
//    func makePullRequestListViewController(coordinator: PullRequestListCoordinatorProtocol, viewModelItem: RepositoryViewModelItem, service: PullRequestService) -> PullRequestListViewController {
//        <#code#>
//    }
//    
